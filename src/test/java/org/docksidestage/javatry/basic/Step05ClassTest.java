...
import org.docksidestage.javatry.basic.st6.buyticket.TestTicketBooth;
...
public class Step05ClassTest extends PlainTestCase {
    ...
    public void test_class_howToUse_basic() {
        // done mayukorin 現在日時を細工するテストケースだけでTestTicketBoothを使うで良いです by jflute (2024/10/29)
    ...
    public void test_class_moreFix_usePluralDays() {
        ...
        log(twoDayPassport.isUsedUp()); // should be false
        // 2日目にインする
        booth.switchCurrentDateTime(LocalDateTime.of(2017, 11, 18, 12, 0));
        twoDayPassport.doInPark();
    ...
    public void test_class_moreFix_wonder_four() {
        ...
        log(fourDayPassport.isUsedUp()); // should be false
        // 3日目にインする
        booth.switchCurrentDateTime(LocalDateTime.of(2017, 11, 19, 12, 0));
        fourDayPassport.doInPark();
        log(fourDayPassport.isUsedUp()); // should be false
        // 4日目
        // 21:00にインしようとする
    ...
    public void test_class_moreFix_wonder_night() {
        ...
        booth.switchCurrentDateTime(lunchDateTime);
        try {
            nightOnlyTwoDayPassport.doInPark();
        } catch (IllegalStateException continued) {
            ...
            log(nightOnlyTwoDayPassport.isUsedUp()); // should be false
            // 18:00にイン
            booth.switchCurrentDateTime(LocalDateTime.of(2017, 11, 18, 18, 0));
            nightOnlyTwoDayPassport.doInPark();
