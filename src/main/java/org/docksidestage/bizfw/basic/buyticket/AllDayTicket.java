 ...
 * @author mayukorin
 */
public class AllDayTicket implements Ticket {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public AllDayTicket(TicketType ticketType) {
        // Ticket の使用可能日数、値段は
    ...
    public void doInPark(LocalDateTime currentDateTime) {
        ...
        // TODO m.inoue doInParkをLimitedTimeTicketと共通で使うために、日付しか使わないのに引数がLocalDateTimeになっているの微妙なような
        // でもよくよく考えると、AllDay Ticketって24時間入れるわけではないから営業時間内のインかどうかのチェックが入るはずだし(実装はしてないけど)、LocalDateTimeを渡しても違和感はないか
