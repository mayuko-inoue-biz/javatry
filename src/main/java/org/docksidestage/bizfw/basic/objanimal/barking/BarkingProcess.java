...
public class BarkingProcess {
    ...
    // done jflute 1on1にて、一杯考えて考えて最終的にすっきりとしたコードに仕上げてくれたことめちゃめちゃ褒める予定 (2024/12/26)
    // まゆこりんさんは本当に素敵です。考えた経験がそのまんま成果で、いつかその力が役に立つでしょう。
    ...
    public BarkingProcess(DownHitPointer downHitPointer) {
        // done mayukorin [ふぉろー] 思い出コメントアウトありがとう！勉強用なので進化の軌跡を残すとプロセスを振り返ることができますね by jflute (2024/12/26)
        // [思い出]
        // this.animal = animal;
